...
class Trade:
    ...
    def new_trade(self, trade_id: str, order_type: str, side: str, enter_or_exit: str, price: float = 0.00,
        ...
        elif self.order['orderType'] == 'STOPLIMIT':
    ...
    def instrument(self, symbol: str, quantity: int, asset_type: int, sub_asset_type: str = None,
    ...
    def modify_side(self, side: Optional[str], order_leg_id: int = 0) -> None:
        ...
        if side:
            ...
            self.order['orderLegCollection'][order_leg_id]['instructions'] = \
